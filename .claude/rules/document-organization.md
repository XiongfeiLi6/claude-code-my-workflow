...
| `referee_reports/` | Referee report source artifacts (md/qmd) — this project's canonical review subdir (elsewhere often named `reviews/`) | `YYYY-MM-DD_[paper]_report.md` |
| `reviews/` | Other review + proofread reports (pre-submission reviews, review-of-reviews, code reviews) | `YYYY-MM-DD_description.md` or a skill-defined stable prefix |
